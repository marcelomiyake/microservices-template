...
{{ Kind build/use prerequisites and link to the Helm chart and detailed runbook. Include probes, dependencies, failure handling, and persistence behavior. }}

### Kubernetes resource budgets

| Pod/workload and container | CPU request | Memory request | CPU limit | Memory limit | Source |
| --- | ---: | ---: | ---: | ---: | --- |
| {{ workload/container, including init or sidecar }} | {{ value }} | {{ value }} | {{ value }} | {{ value }} | [{{ chart }}]({{ path }}) |
